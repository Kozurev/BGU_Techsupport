<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template name="new_app_form">
		...
		<script>
            ...
            fio:            { required: true, maxlength: 45 },
            email:          { maxlength: 45 },
            },
            messages: {
            subject:        { required: "Это поле обязателдьно к заполнению" },
            description:    { required: "Это поле обязателдьно к заполнению" },
            fio:            { required: "Это поле обязателдьно к заполнению", maxlength: "Длинна значения данного поля не должна превышаьть 45 символов" },
    	...
    	<!--Встплывающее окно с формой обращения-->
        <div id="ekkoLightbox-1" class="ekko-lightbox modal fade in" tabindex="-1" style="padding-right: 17px;">
            <div class="modal-dialog" style="width: auto; max-width: 1032px;">
                <div class="modal-content"><div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                    <h4 class="modal-title">Форма обращения</h4>
                </div>
