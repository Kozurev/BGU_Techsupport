$(function(){
    $("body")
        ...
        .on("click", "#applications_show", function(e){
            e.preventDefault();
            loaderOn();
            var date_from = $("#date_from").val();
            var date_to = $("#date_to").val();
            refreshTableApplications(date_from, date_to);
        });
});


function refreshTableApplications(date_from, date_to) {
    $.ajax({
        type: "GET",
        url: "",
        data: { date_from: date_from, date_to: date_to, action: "refreshTable" },
...
function saveAppComment(Form) {
    ...
    $.ajax({
        ...
        success: function(responce){
            ...
            var Forum = $(".forum");
            var forumTitle = Forum.find(".section-title").clone();
            var username = $(".current-user").text();
            var datetime = responce;
            Forum.find(".section-title").remove();
